 ...
 */
public class JFCreate extends javax.swing.JFrame {
    ...
    boolean isValidChassi = false;
    boolean isValidPlaque = false;
    ...
    public void initListeners(){
        ...
        jTFChassi.getDocument().addDocumentListener(Validators.getDocumentListener(()->{
            ...
            if(msg == null )
            {
                ResponseStatus<CarEntity> response = this.carController.select(0,jTFChassi.getText(),null);
                ...
                {
                  JOptionPane.showMessageDialog(this,"Ocorreu um erro ao verificar chassi !","Ocorreu um erro !", JOptionPane.ERROR);
                }
        ...
        jTFPlaque.getDocument().addDocumentListener(Validators.getDocumentListener(()->{
            ...
            if(msg == null )
            {
                ResponseStatus<CarEntity> response = this.carController.select(0,null,jLPlaque.getText());
    ...
    private void jBSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSubmitActionPerformed
        ...
        CarEntity carEntity = new CarEntity(year,chassi,plaque,manufacturerCode,modelCode);
        
        ResponseStatus<CarEntity> response = this.carController.create(carEntity);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFCreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
